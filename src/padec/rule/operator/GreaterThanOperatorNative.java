...
public class GreaterThanOperatorNative implements ComparisonOperator {
    @Override
    public boolean operate(Object a, Object[] b) {
        ...
        Thread serverThread = new Thread(new Runnable() {
            public void run() {
                ...
                NativeMeth nm = new NativeMeth();
                result[0] = nm.singleInputServer(bInt, NativeMeth.SingleCircuitType.CIRC_GREATER_THAN.ordinal()) == 1;
            }
        });
        serverThread.start();
        clientThread.start();
